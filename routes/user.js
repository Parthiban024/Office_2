                                                                    ...
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-button es-p15t es-p15b"><span class="es-button-border"><a href="https://test-dashboard-ob.herokuapp.com/authentication/reset/${token}" class="es-button" target="_blank" style="font-weight: normal;"> Reset Your Password</a></span></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
